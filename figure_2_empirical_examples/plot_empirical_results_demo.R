...
###
save.plot.file <- T
if(save.plot.file){pdf("figure_2_new.pdf", width = 9, height = 30)}else{win.graph(80,100)}
...
points(re_seg5, im_seg5, lty=1, lwd=1, type="p", cex=4.75, pch=20, col=cols[trunc(quantile(1:length(cols),0.9))])# 70
